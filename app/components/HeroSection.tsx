            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
                <div className="col-span-7 place-self-center text-center sm:text-left">
                    <h1 className="text-white mb-4 text-6xl font-extrabold">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 via-red-500 to-orange-500">Hello, I'm {" "}</span>
                        <br />
                        <TypeAnimation
                            sequence={[
                    ...
                    <p className="text-[#ADB7BE] text-2xl mb-6">
                    ...
                    <div className="mt-10 md:flex items-center lg:block xl:flex">
                        <Link href="/#contact">
                            <button className="px-6 py-4 w-full rounded-full sm:w-fit mr-4 text-xl hover:bg-slate-200 mb-4 sm:mb-0 bg-gradient-to-br from-yellow-500 via-red-500 to-orange-500 text-white">
                                Contact Me
                            </button>
                        </Link>
                        <Link href="/#about">
                            <button className="px-1 py-1 w-full rounded-full sm:w-fit bg-transparent text-xl bg-gradient-to-br from-yellow-500 via-red-500 to-orange-500">
                        ...
                        <div className="flex md:ml-6 mt-6 mb-3 lg:mt-6 md:my-0 xl:mt-0 justify-center sm:justify-start gap-10 items-center">
                            {SocialMedia.map(({ icon, link, name }, index) => (
                                <a key={index} href={link}>
                                    <div className="rounded-full relative bg-gradient-to-br p-[2px] from-yellow-500 via-red-500 to-orange-500 flex items-center justify-center">
