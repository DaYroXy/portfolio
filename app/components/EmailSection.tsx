        ...
        <section id="contact" className='grid md:grid-cols-2 py-12 gap-4'>
            ...
            <div className="">
                <form onSubmit={(e) => {
                    ...
                    <button disabled={sent} className={`transition-all rounded-lg w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-4 px-5 ${sent ? "cursor-not-allowed" : ""}`}>Send Your Message</button>
                    {sent && (
